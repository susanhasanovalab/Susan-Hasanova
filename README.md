# Susan Hasanova
### Biotechnologist | Bioinformatics Researcher | AI-Driven Biotechnology Specialist 

I am a highly motivated **Biotechnology** student at **Baku State University** (SABAH groups), dedicated to integrating **Artificial Intelligence** and **Computational Genomics** to solve critical biological challenges. As the Founder of **NexaGen**, I bridge the gap between traditional molecular biology and modern data science through community-driven open-source development.

---

## 🎓 Academic Profile & Excellence
* **B.Sc. in Biotechnology** (Senior Year) – Baku State University.
* **Academic Performance:** Cumulative GPA of **94.6/100**.
* **Language Proficiency:** IELTS Score **7.0** (Professional Working Proficiency).
* **Scholarships:** 100% Scholarship Winner of **GenAI** and **AI-Based Programming** programs at Holberton School and Code Academy.
...
**Bioinformatics Tools:** Expert in NCBI BLAST, Ensembl, PyMOL, AutoDock, and KEGG Pathway Analysis.
* **Wet-Lab Techniques:** Proficient in DNA/RNA extraction, PCR analysis, gel electrophoresis, and CRISPR/Cas9 applications.
...
* **Founder & President @ NexaGen:** Leading Azerbaijan's first student-led bioinformatics and AI community.
* **DNAx (Genetic Analyzer):** Developed a C#-based tool for sequence interpretation and mutation hotspot identification.
* **Agricultural Research:** Implementing genetic data analysis for crop improvement at the Research Institute of Vegetable Growing.

---

## 📫 Connect with Me
* **LinkedIn:** [linkedin.com/in/susan-hasanova]
* **Professional Email:** hasanovaa.ssssss@gmail.com
  **Current Location:** Baku, Azerbaijan 

---
*"At the intersection of life and code, we discover the future."*
